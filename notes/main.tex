...
\begin{align}
  \bD(K, T)\balpha^R + \bD(K^\prime, T)\bbeta^R &= \bV^R, \\
  \bD(K, T)\balpha^I + \bD(K^\prime, T)\bbeta^I &= \bV^I,
\end{align}
and the constraint I2 as the one equation
\begin{equation}
    \diag\bigg(\bD(K^{\prime}, T)\balpha^R\bV^{R^\top} + \bD(K^{\prime\prime}, T)\bbeta^R\bV^{R^\top} + \bD(K^{\prime}, T)\balpha^I\bV^{I^\top} + \bD(K^{\prime\prime}, T)\bbeta^I\bV^{I^\top}\bigg) = \bm 0.
\end{equation}
...
\begin{align}
  ...
  \end{array}\right]\right)\left[\begin{array}{c} \balpha^R \\ \bbeta^R \\ \balpha^I \\ \bbeta^I \end{array}\right]\right),
\end{align}
