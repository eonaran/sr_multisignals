...
\section{$t$ Near $t_i$, Negative Term of $N^{\prime\prime}(t)$}

Main contribution:
\[ \la \bK_0^{-1} \bk_0(t), \bK_0^{-1} \bk_2(t) \ra = \bk_0(t)^\top \bK_0^{-2} \bk_2(t). \]

\section{$t$ Near $t_i$, Positive Term $N^{\prime\prime}(t)$}
